...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Sudarshan", "http:sudarsha.gowda.com",
			"sudarshan@gmail.com");
	@SuppressWarnings("rawtypes")
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Api Documentation",
			"Details about Rest Api Documentation", "1.0", "urn:tos", DEFAULT_CONTACT, "Apache 2.0",
