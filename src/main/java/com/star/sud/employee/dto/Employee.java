...
@ApiModel(description = "Information Related to Employee")
public class Employee implements Serializable {
	...
	@ApiModelProperty("Name should be minimum of 2 character")
	private String empName;

	@Past(message = "DOB should be in past")
	@ApiModelProperty("DOB should be in past")
	private Date empDob;

	@Email(message = "Email is not matching the critiria")
	@ApiModelProperty("Email is not matching the critiria")
